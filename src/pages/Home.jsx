  ...
  <div className="hero-overlay">
    ...
    />
      ...
      <nav className="nav-bar">
        ...
        <a href="https://forms.gle/HmqRYtJvfb1SWQya7" target="_blank" rel="noopener noreferrer">
      ...
      <section className="leaders-section" id="leaders">
        <div className="leaders-content">
          ...
          <div className="leaders-text">
            ...
            <p>
              The Data Science Academy (DSA) is a future-forward learning institution based in South Africa, dedicated to equipping the next generation of African innovators with practical skills in data science, artificial intelligence, and emerging technologies that define the Fourth Industrial Revolution (4IR).
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="team">
        ...
        <div className="team-members">
          <div>
            ...
            <p><span className="name">GEORGE</span><br /><span className="surname">THOSAGO</span></p>
          </div>
          <div>
            <img src="assets/images/team-david2.jpeg" alt="David Sithole" />
            <p><span className="name">DAVID</span><br /><span className="surname">SITHOLE</span></p>
          </div>
          <div>
            <img src="assets/images/team-keith2.jpeg" alt="Keith Ramuneyiwa" />
            <p><span className="name">KEITH</span><br /><span className="surname">RAMUNEYIWA</span></p>
          </div>
          <div>
            <img src="assets/images/team-owen2.jpeg" alt="Owen Rampora" />
            <p><span className="name">OWEN</span><br /><span className="surname">RAMPORA</span></p>
          </div>
          <div>
            <img src="assets/images/team-mika2.jpeg" alt="Mika Chipana" />
            <p><span className="name">MIKA</span><br /><span className="surname">CHIPANA</span></p>
          </div>
        </div>
      </section>
      ...
      <p>With over 15 strategic partners, we aim to bring more solutions to your business through international interfaces.</p>
    </div>
